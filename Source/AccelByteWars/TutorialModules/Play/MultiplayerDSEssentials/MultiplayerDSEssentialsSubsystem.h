...
#include "MultiplayerDSEssentialsSubsystem.generated.h"

UCLASS()
class ACCELBYTEWARS_API UMultiplayerDSEssentialsSubsystem : public UMultiplayerDSEssentialsSubsystemBase
{
	GENERATED_BODY()
