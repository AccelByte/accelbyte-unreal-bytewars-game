...
#include "ChallengePeriodWidget_Starter.h"
#include "ChallengeWidget_Starter.h"
#include "Core/System/AccelByteWarsGameInstance.h"
#include "Core/UI/AccelByteWarsBaseUI.h"
#include "CommonButtonBase.h"

void UChallengePeriodWidget_Starter::NativeOnActivated()
{
...
void UChallengePeriodWidget_Starter::NativeOnDeactivated()
{
...
UWidget* UChallengePeriodWidget_Starter::NativeGetDesiredFocusTarget() const
{
	return Btn_Back;
}

void UChallengePeriodWidget_Starter::OpenChallengeMenu(const EAccelByteModelsChallengeRotation Period)
{
	...
	BaseUIWidget->PushWidgetToStack(
		...
		{
			if (UChallengeWidget_Starter* ChallengeWidget = Cast<UChallengeWidget_Starter>(&Widget))
			{
