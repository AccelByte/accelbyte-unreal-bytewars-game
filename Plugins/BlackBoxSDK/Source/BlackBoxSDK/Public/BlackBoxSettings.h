...
public:
    ...
    UPROPERTY(
        ...
        GlobalConfig,
        Category = "Issue Reporter",
        Meta = (EditCondition = "!HideIssueReporterSettings && EnableIssueReporter", HideEditConditionToggle))
    FBlackboxInputChord IssueReporterHotkey = FBlackboxInputChord(EKeys::F8, false, false, false, false);
    ...
    UPROPERTY(
        ...
        Category = "Issue Reporter",
        Meta =
            (EditCondition = "!HideIssueReporterSettings && EnableIssueReporter",
             HideEditConditionToggle,
             DisplayName = "Include Log"))
    bool IncludeGameLogInIssueReport = true;
    ...
    /**
     * Show unreal dialog window with customizable title and message.
     *
     * @param DialogTitle the title of the dialog window.
     * @param DialogMessage the message of the dialog window.
     */
    void ShowDialog(const FString& DialogTitle, const FString& DialogMessage);
