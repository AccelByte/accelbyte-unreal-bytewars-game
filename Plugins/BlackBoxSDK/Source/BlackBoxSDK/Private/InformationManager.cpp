...
SDKInformation FInfoManager::GetSDKInformation()
{
    ...
    SDKInfo.IssueReporterHotkey = BlackBoxIssueReporter::DeserializeInputChord((UTF8_TO_TCHAR(bbx_config_get_issue_reporter_hotkey())));
    ...
    SDKInfo.IncludeGameLogInIssueReport = bbx_config_get_include_log_in_issue_report();
    return SDKInfo;
}
...
void FInfoManager::UpdateBlackBoxConfiguration(const SDKInformation& SDKInfo_)
{
    ...
    bbx_config_set_issue_reporter_hotkey(TCHAR_TO_UTF8(*BlackBoxIssueReporter::SerializeInputChord(SDKInfo_.IssueReporterHotkey)));
    ...
    bbx_config_set_include_log_in_issue_report(SDKInfo_.IncludeGameLogInIssueReport);
